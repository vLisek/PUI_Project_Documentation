...
\subsection{Housekeeping / Obsługa pięter (Interfejs mobilny)}
...
Aplikacja mobilna przeznaczona dla działu technicznego. Moduł służy do zarządzania zgłoszeniami dotyczącymi usterek i awarii w obrębie infrastruktury hotelowej, umożliwiając szybką reakcję na problemy techniczne zgłaszane przez gości lub inny personel.

\subsection{Recepcja (Interfejs desktopowy)}
Stanowisko operacyjne służące do nadzoru nad bieżącym obłożeniem hotelu. Interfejs ten dostarcza kluczowych informacji o stanie pokoi, co pozwala pracownikom recepcji na sprawną realizację procesów zameldowania i wymeldowania bez konieczności zarządzania zadaniami pozostałych działów.
...
Nadrzędny moduł zarządczy odpowiedzialny za optymalizację pracy całego obiektu. Menadżer posiada dostęp do danych kadrowych, finansowych oraz harmonogramów pracy, a także zajmuje się delegowaniem zadań i analityką wydajności poszczególnych pionów hotelowych.
