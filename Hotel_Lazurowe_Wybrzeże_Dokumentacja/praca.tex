...
\author{
    \begin{tabular}{ll}
        Krystian Filipek (134907) & Konrad Fugiel (134909) \\[0.1cm]
        Oliwier Hędrzak (134913)  & Bartłomiej Kufel (134936) \\[0.1cm]
        \multicolumn{2}{c}{Filip Lisowski (134913)}
    \end{tabular}
}
\noAlbum{ }
...
\titlePL{Interfejs systemu hotelowego "French Riviera" – dokumentacja projektowa}
\titleEN{Hotel "French Riviera" system interface – project documentation}

\shorttitlePL{System hotelowy "French Riviera"} 
\shorttitleEN{Hotel system "French Riviera"}
